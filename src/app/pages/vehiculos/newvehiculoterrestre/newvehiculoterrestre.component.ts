...
@Component({
  selector: 'app-newvehiculoterrestre',
  templateUrl: './newvehiculoterrestre.component.html',
  styleUrls: ['./newvehiculoterrestre.component.scss']
})
export class NewvehiculoterrestreComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    .subscribe(data => {
      this.logistica = data;
      this.select = this.logistica.find((c) => {return c.idLogistica == 1});
