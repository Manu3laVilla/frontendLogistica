...
const routes: Routes = [
  ...
  { path: 'detail', loadChildren: () => import('./pages/pedidos/detail/detail.module').then(m => m.DetailModule) },
  { path: 'detail/:id', loadChildren: () => import('./pages/pedidos/detail/detail.module').then(m => m.DetailModule) }
];
